...
from .StaffViews import ReportCardView


urlpatterns = [

    path('', views.home_only, name="home"),
...
path('add_tutor/', HodViews.add_tutor, name="add_tutor"),
path('profile_tutor/', views.profile_tutor, name="profile_tutor"),

path('view_tutor/', views.view_tutor, name="view_tutor"),
path('tutor_dash/', views.tutor_dash, name="tutor_dash"),
path('assign_tutor/', HodViews.assign_tutor, name="assign_tutor"),
path('assign_tutor_save/', HodViews.assign_tutor_save, name="assign_tutor_save"),
path('view_tutor_admin/', HodViews.view_tutor_admin, name="view_tutor_admin"),
path('view_mark/<id>', views.view_mark, name="view_mark"),



    path('add_tutor_save/', HodViews.add_tutor_save, name="add_tutor_save"),
    ...
    path('report_card/<int:id>/', StaffViews.report_card, name="report_card"),
    path('report_card_print/<int:id>/', ReportCardView.as_view(), name='report_card'),
